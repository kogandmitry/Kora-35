...
def build_receipt():
    ...
    add_title(
        ...
        [("Дата события", "16 августа 2026 г."), ("Сумма", "5 000 (Пять тысяч) рублей 00 копеек")],
        title_size=20,
        title_before=6,
        subtitle_after=8,
        metadata_after=0,
    ...
    set_font(p.add_run("в качестве задатка / обеспечительного платежа за бронирование базы отдыха «Литейщик» для проведения корпоративного выезда КОРА 35 16 августа 2026 года."))
